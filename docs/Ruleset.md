...
> **v0.8 amendments:** the Wild archetype's **Metamorphosis** and **Fusion (Apex)** mechanics, and a clarification of **The Ascended**'s item consumption, are documented in the companion doc *Ruleset v0.8 Amendments* (kept separate until folded into this v0.7 text — the §5-amendment pattern).
